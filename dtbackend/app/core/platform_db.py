...
class DatabaseConnectionFactory:
    ...
    @staticmethod
    def execute_query(platform: Platform, query: str, params: Optional[dict] = None) -> dict:
        """
    ...
    @staticmethod
    def _execute_clickhouse(platform: Platform, query: str, params: Optional[dict] = None) -> dict:
    ...
    @staticmethod
    def _execute_mssql(platform: Platform, query: str, params: Optional[dict] = None) -> dict:
        """Execute MSSQL query"""
    ...
    @staticmethod
    def _execute_postgresql(platform: Platform, query: str, params: Optional[dict] = None) -> dict:
