...
import { Plus, Trash2, Database, BarChart3, PieChart, LineChart, Table, Calendar, Filter, Hash, Type, List, Play, Loader2 } from "lucide-react"
        ...
        <div className="mb-8">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600 text-lg">
              Özelleştirilmiş rapor ve dashboard widget'ları oluşturun
            </p>
          </div>
        </div>
