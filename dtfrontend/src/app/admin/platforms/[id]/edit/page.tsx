              ...
              {activeTab === 'database' && (
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                  ...
                  <div className="space-y-6">
                    ...
                    {(!formData.db_configs || (formData as any).db_configs?.length === 0) && (
                      <div className="text-center py-8 text-gray-500">
                        Henüz veritabanı yapılandırması eklenmemiş
                      </div>
                    )}
                                  ...
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="md:col-span-2">
                                      <label className="flex items-center gap-2 cursor-pointer">
                                        <input
                                          type="checkbox"
                                          checked={subfeature.underConstruction || false}
                                          onChange={(e) => {
                                            const newFeatures = [...(formData.theme_config as any)?.features || []];
                                            newFeatures[index].subfeatures[subIndex].underConstruction = e.target.checked;
                                            handleThemeConfigChange('features', newFeatures);
                                          }}
                                          className="rounded border-gray-300 text-orange-600 focus:ring-orange-500"
                                        />
                                        <span className="text-xs font-medium text-gray-700">Yapım Aşamasında</span>
                                      </label>
                                    </div>
                                  </div>
                                </div>
