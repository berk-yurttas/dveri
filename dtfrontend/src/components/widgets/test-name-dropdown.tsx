...
interface TestNameDropdownProps {
  options: TestNameOption[]
...
export function TestNameDropdown({
  options,
  selectedValue,
  onSelect,
    ...
    <div className={`flex justify-center ${className}`}>
      <div className="relative" ref={dropdownRef}>
        ...
        >
          <span>
            {loading ? "Yükleniyor..." : 
             options.length === 0 ? "Test yok" :
             (currentOption?.name || "Test seçin")}
          </span>
